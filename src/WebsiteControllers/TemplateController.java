...
public class TemplateController {
    ...
    public ModelAndView view() throws ParseException {
        ...
        if(( staff.getName().equals("Russell Gwynn") || staff.getName().equals("Ronny Pelucci")|| staff.getName().equals("Guest1")|| staff.getName().equals("Guest2")|| staff.getName().equals("Guest3")|| staff.getName().equals("John Pelucci")) || staff.getName().equals("Sanjay Sookdeo")) {
            return view;
        }
