...
<div class="container">
    <div class="row">
        ...
        <section>
            <h1 class="entry-title"><span>Edit Menu Item</span></h1>
            <hr>
            <form class="form-horizontal" name="signup" id="signup" method="post" action="/edititem"  enctype="multipart/form-data">
                <div class="form-group">
                    <label class="control-label col-sm-3">Name</label>
                    <div class="col-md-8 col-sm-9">
                        <div class="input-group">
                            <input type="name" class="form-control" name="emailid" id="itemname" value="${name}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-5 col-sm-8">
                        <div class="input-group" style="padding-top: 8px">
                            <label class="form-check-label">
                                <input type="radio" class="form-check-input" onclick="yolo(this.id)" name="radio" id="tea" value="option1" ${tea}>
                                Tea
                            </label>

                            <label class="form-check-label">
                                <input type="radio" class="form-check-input" onclick="yolo(this.id)" name="radio" id="lunch" value="option2" ${lunch}>
                                Lunch
                            </label>
                            <label class="form-check-label">
                                <input type="radio" class="form-check-input"  onclick="yolo(this.id)" name="radio" id="standard" value="option3" ${standard} >
                                Standard
                            </label>

                            <label class="form-check-label">
                                <input type="radio" class="form-check-input" onclick="yolo(this.id)" name="radio" id="takeaway" value="option3" ${takeaway} >
                                Takeaway
                            </label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5 col-sm-8">
                        <textarea class="form-control" name="desc" rows="5"  value="${desc}" id="comment">${desc}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group" >
                    ...
                    <div class="col-md-5 col-sm-8">
                        <div class="input-group">
                            <input  type="file" name="img" id="file" class="form-control upload" value="${phname}"
...
<script>
    $(document).ready(function () {
                if(document.getElementById("tea").checked){
                    document.getElementById("time").value="tea";
                }
                else if(document.getElementById("lunch").checked){
                    document.getElementById("time").value="lunch";
                }
                else if (document.getElementById("standard").checked){
                    document.getElementById("time").value="standard";
                }
                else if (document.getElementById("takeaway").checked){
                    document.getElementById("time").value="takeaway";
                }
